...
// import 'package:xiaoqiu_sports/model/VideoModel.dart';
// import 'package:xiaoqiu_sports/model/WeiBoDetail.dart';
// import 'package:xiaoqiu_sports/pages/find/find_hot_search.dart';
// import 'package:xiaoqiu_sports/pages/find/topic_detail.dart';
...
var guessPageHandler = new Handler(
    handlerFunc: (BuildContext context, Map<String, List<String>> params) {
  return GuessPage();
});
