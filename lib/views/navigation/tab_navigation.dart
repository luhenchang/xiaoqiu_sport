...
import 'package:xiaoqiu_sport/views/news/news_page.dart';
import 'package:xiaoqiu_sport/views/match/match_page.dart';
import 'package:xiaoqiu_sport/views/user/user_page.dart';
import 'package:xiaoqiu_sport/views/video/rank_page.dart';
import 'package:xiaoqiu_sport/views/match/lanqiu_ziliao_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: PageView(
        ...
        children: <Widget>[MatchPage(), NewsPage(), RankPage(), LanqiuZiliaoPage(),UserPage()],
      ),
      bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            _bottomItem('视频', 'assets/images/ic_hot_normal.png',
                'assets/images/ic_hot_selected.png', 2),
            _bottomItem('资料', 'assets/images/ic_match_normal.png',
                'assets/images/ic_match_selected.png', 3),
